...
<div class="main-wrapper" >
    <div class="page-wrapper" id="inicio" >
        <div class="content">
            <div class="row">
                <div class="col-sm-4 col-3" style="padding-left: 40px!important;">
                    <h4 class="page-title"  id="inicio-pacientes">Pacientes Registrados</h4>
                </div>
                <!-- BOTON MODAL -->
                <div  class="col-sm-12 col-lg-12 text-right m-b-20">
                    <button title="Generar pdf" id="print" class="btn btn-primary float-right btn-rounded btn-press"><img src="{{asset('assets/img/pdf.png')}}" style="width: 20px"> </button>
                    <a href="{{route('AnadirP')}}" class="btn btn-primary float-right btn-rounded btn-press"><i class="fa fa-plus"></i> Añadir</a>
