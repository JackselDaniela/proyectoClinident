                    ...
                    <table class="table table-striped custom-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$tratamiento->especialidad_tratamiento;}}</td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" maxlength="10" value="cod-" name="codigo_tratamiento" id="codigo_tratamiento" type="text" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" value="cod" name="especialidad_tratamiento" id="especialidad_tratamiento" type="text" required>
                                            </div>
                                        </div>
